...
const teamDetails = [
  {
    teamName: "Team A",
    description: "The men's volleyball team with exceptional skills in power and defense strategies.",
  ...
  {
    teamName: "Team B",
    description: "The women's volleyball team known for their agility and teamwork.",
