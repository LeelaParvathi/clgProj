...
const tournaments = [
  {
    id: "t1",
    name: "Inter-University Basketball Championship 2024",
    date: "2024-04-10",
    participants: [
      { name: "Team Warriors", weapon: "Men's Team" },
      { name: "Team Phoenix", weapon: "Women's Team" }
    ],
    faculty: ["Coach Michael Jordan", "Coach Lisa Thompson"]
  },
  {
    id: "t2",
    name: "State Basketball Tournament 2024",
    date: "2024-05-15",
    participants: [
      { name: "Team Thunder", weapon: "Men's Team" },
      { name: "Team Lightning", weapon: "Women's Team" }
    ],
...
const achievements = [
  {
    ...
    description: "Men's basketball team secured first place in the national championship",
    image: "https://images.unsplash.com/photo-1546519638-68e109498ffc?auto=format&fit=crop&q=80&w=800"
  },
  {
    year: "2022",
    title: "Silver Medal - State Championships",
    description: "Women's team achieved runner-up position in state tournament",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center text-sm">
        ...
        <ChevronRightIcon className="w-4 h-4 mx-2 text-gray-500" />
        <span className="text-gray-600 font-medium">Basketball</span>
      </div>
