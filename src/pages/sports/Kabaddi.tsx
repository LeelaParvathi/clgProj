    ...
    participants: [
      {
        ...
        description: "Elite kabaddi team known for aggressive raiding and strategic defense.",
        keyPlayers: ["Rahul Kumar (Captain)", "Ajay Singh", "Deepak Niwas"],
        achievements: ["Champion - State League 2023", "Best Raider Award - Nationals 2022"]
      },
      {
        name: "Team Defenders",
        division: "Women's Division",
        description: "Strong defensive unit with exceptional chain tackling abilities.",
        keyPlayers: ["Priya Sharma (Captain)", "Pooja Rani", "Sakshi Kumari"],
        achievements: ["Winner - Regional Tournament 2023", "Best Defense Award - State Championship 2022"]
      },
      {
        name: "Team Warriors",
        division: "Junior Division",
        description: "Young talented squad with a mix of raiders and defenders.",
        keyPlayers: ["Amit Hooda (Captain)", "Rohit Kumar", "Naveen Kumar"],
        achievements: ["Junior Division Champions - 2023", "Most Promising Team - 2022"]
      }
    ],
    faculty: ["Coach Anup Kumar", "Coach Rakesh Kumar"],
    performanceHistory: [
      { year: "2023", result: "Champion" },
      { year: "2022", result: "Semi-finalist" }
    ]
  },
  {
    id: "t2",
    name: "National Kabaddi Championship 2024",
    date: "2024-05-15",
    participants: [
      {
        name: "Team Eagles",
        division: "Senior Division",
        description: "Experienced team with a perfect blend of attack and defense.",
        keyPlayers: ["Pardeep Narwal (Captain)", "Pawan Sehrawat", "Manjeet Chillar"],
        achievements: ["National Champions 2023", "Best Team Spirit Award 2022"]
      },
      {
        name: "Team Panthers",
        division: "Sub-Junior Division",
        description: "Rising stars showcasing innovative kabaddi techniques.",
        keyPlayers: ["Nitesh Kumar (Captain)", "Surender Gill", "Mohit Goyat"],
        achievements: ["Sub-Junior Champions 2023", "Most Improved Team 2022"]
      }
    ],
    faculty: ["Coach Ram Mehar Singh"],
    performanceHistory: [
      { year: "2023", result: "Winner" },
...
const galleryImages = [
  "https://images.unsplash.com/photo-1582630699459-681d3c951ce0?auto=format&fit=crop&q=80&w=1200",
  "https://images.unsplash.com/photo-1582630699451-bdb31e2d235b?auto=format&fit=crop&q=80&w=1200",
  "https://images.unsplash.com/photo-1582630699466-ab6c0f927b8b?auto=format&fit=crop&q=80&w=1200"
];

const achievements = [
  {
    year: "2023",
    title: "National Kabaddi Championship Winners",
    description: "Team secured first place in the national championship",
    image: "https://images.unsplash.com/photo-1582630699459-681d3c951ce0?auto=format&fit=crop&q=80&w=800"
  },
  {
    year: "2022",
    title: "Pro Kabaddi League Champions",
    description: "Outstanding performance throughout the season",
    image: "https://images.unsplash.com/photo-1582630699451-bdb31e2d235b?auto=format&fit=crop&q=80&w=800"
  },
  {
    year: "2021",
    title: "Inter-University Kabaddi Tournament",
    description: "Champions of the prestigious tournament",
    image: "https://images.unsplash.com/photo-1582630699466-ab6c0f927b8b?auto=format&fit=crop&q=80&w=800"
  }
];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center text-base border-b border-gray-200">
        ...
        <span className="text-gray-800 font-semibold text-lg">Kabaddi</span>
      </div>
