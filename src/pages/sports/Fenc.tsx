...
const galleryImages = [
  "https://th.bing.com/th/id/OIP.22gMeQO7QGK1Rn8wlzAnowHaE8?rs=1&pid=ImgDetMain",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center text-base border-b border-gray-200">
        ...
        <span className="text-gray-800 font-semibold text-lg">Fencing</span>
      </div>
      ...
      {selectedTeam && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-8 max-w-2xl w-full">
            <h3 className="text-2xl font-bold mb-6 text-[#900] border-b-2 border-[#900] pb-2">
              {selectedTeam.name} - {selectedTeam.weapon}
            </h3>
